              ...
              <div className="md:px-14 pt-7">
                <form className="md:text-sm text-base font-parrafo" name="contact" method="POST" data-netlify="true">
                  ...
                  <div className="w-full font-parrafo text-center">
                    <button className="transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110  text-lg text-white md:text-celeste font-bold pb-3">
                      Olvidaste tu contraseña?
                    </button>
                    <h4 className="text-white md:text-celeste">
                      No tienes una cuenta?
                    </h4>
                    <Link to={"/Registrate"}>
                      <h4 className="transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110 font-bold text-lg text-white md:text-celeste pb-20">
                        Regístrate
                      </h4>
                    </Link>
                  </div>
