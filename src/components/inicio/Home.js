            ...
            <div className="pt-8 md:flex">
              <div className="w-full md:w-1/2">
                ...
                <div className="pt-3 flex justify-evenly text-white">
                  ...
                  <button onClick={()=>{this.handleClick(this.props.items[3].id)}} className="bg-verde hover:hoverver rounded-lg px-4 py-1 text-white font-bold font-titulo">
                    Agregar
                  </button>
                </div>
              </div>
              <div className="w-full md:w-1/2 pt-6 md:pt-0">
                ...
                <div className="pt-3 flex justify-evenly text-white">
                  ...
                  <button onClick={()=>{this.handleClick(this.props.items[2].id)}} className="bg-verde hover:hoverver rounded-lg px-4 py-1 text-white font-bold font-titulo">
                    Agregar
                  </button>
                </div>
              </div>
